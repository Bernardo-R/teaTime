...
export default function FAQ(){
  ...
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    <div class="mx-auto max-w-2xl lg:text-center">
      ...
      <p class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">You've got questions. We've got answers!</p>
      <p class="mt-6 text-lg leading-8 text-gray-600">You may run into trouble on your quest for the perfect tea. We want you to know you're not alone. Here are some commonly asked questions -</p>
    </div>
      ...
      <dl class="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
        <div class="relative pl-16">
          <dt class="text-base font-semibold leading-7 text-gray-900">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#f8fafc" class="w-6 h-6">
               <path stroke-linecap="round" stroke-linejoin="round" d="M9.879 7.519c1.171-1.025 3.071-1.025 4.242 0 1.172 1.025 1.172 2.687 0 3.712-.203.179-.43.326-.67.442-.745.361-1.45.999-1.45 1.827v.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9 5.25h.008v.008H12v-.008Z" />
            </svg>
            </div>
            Is Tea Time just a fantastical creation or a secret tea society I stumbled upon?
          </dt>
          <dd class="mt-2 text-base leading-7 text-gray-600">
             Bravo, tea detective! Tea Time is indeed a whimsical figment of creativity, a mystical tea haven conjured up 
             for the sheer joy of tea enthusiasts. While not a secret society, we invite you to explore the enchanting world 
             of Tea Time, where teapots sing lullabies, and tea leaves share tales of their steeped adventures. Sip, savor, 
             and revel in the imaginary tea experience!</dd>
        </div>
        <div class="relative pl-16">
          <dt class="text-base font-semibold leading-7 text-gray-900">
            <div class="absolute left-0 top-0 flex h-10 w-10 items-center justify-center rounded-lg bg-indigo-600">
            ...
            Can I invoke the warranty if my teapot refuses to brew anything other than disco-themed teas?
          </dt>
          <dd class="mt-2 text-base leading-7 text-gray-600">
             Ah, the rebellious teapot phase! While we celebrate its zest for life, our warranty specifically covers defects 
        ...
        <div class="relative pl-16">
          ...
          <dd class="mt-2 text-base leading-7 text-gray-600">
             Cats and tea – a classic tale of unpredictable mayhem! In the event of a feline-fueled tea catastrophe, 
        ...
        <div class="relative pl-16">
          <dt class="text-base font-semibold leading-7 text-gray-900">
            ...
            Can I use Tea Time products for non-tea-related activities, like soup or coffee?
          </dt>
          <dd class="mt-2 text-base leading-7 text-gray-600">
             While we appreciate your creativity, our products are crafted with tea in mind. Attempting to repurpose them for 
